 ...
 *******************************/
if( !class_exists('QcPDrating') ){
	
	class QcPDrating{
		
		public $plugin_name = "pnd"; //Without spaces
		public $plugin_full_name = "Simple Business Directory";
		public $logo_url;
		
		public $plugin_rating_url = "https://wordpress.org/plugins/phone-directory/#reviews";
		
		public function __construct(){
			$this->logo_url = qcpnd_IMG_URL . "/logo.png";
		}
		...
		?>
			<div class="qc-review-notice">
				...
				<div class="qc-review-text">
					...
					<h3><?php esc_html_e( 'Leave A Review for Simple Business Directory?', 'qc-sld' ) ?></h3>
					
					<p><?php esc_html_e( 'We hope you\'ve enjoyed using <b>Simple Business Directory</b>! Would you consider leaving us a review on WordPress.org?', 'qc-opd' ) ?></p>
					
					<ul class="qc-review-ul">
					
						<li><a href="<?php echo $this->plugin_rating_url; ?>" target="_blank"><span class="dashicons dashicons-star-filled"></span><?php esc_html_e( 'Leave A Review', 'qc-sld' ) ?></a></li>
						 <li><a href="<?php echo $dismiss_url ?>"><span class="dashicons dashicons-yes"></span><?php esc_html_e( 'I\'ve already left a review', 'qc-sld' ) ?></a></li>
						 <li><a href="<?php echo $later_url ?>"><span class="dashicons dashicons-calendar"></span><?php esc_html_e( 'Maybe Later', 'qc-sld' ) ?></a></li>
						 <li><a href="<?php echo $dismiss_url ?>"><span class="dashicons dashicons-no"></span><?php esc_html_e( 'Never show this again', 'qc-sld' ) ?></a></li>
...
$qc_sbd_rating = new QcPDrating();

$qc_sbd_rating->plugin_name = 'pnd';
$qc_sbd_rating->plugin_full_name = 'Simple Business Directory';
$qc_sbd_rating->plugin_rating_url = 'https://wordpress.org/plugins/phone-directory/#reviews';
