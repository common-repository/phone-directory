...
== Description ==
= Multipurpose Business Directory Plugin with Maps =

Simple Business Directory is a <strong>Multi-Purpose & Versatile Listing Directory</strong> WordPress plugin. Suitable for Single Page Business Directory Listing with Google Maps or OpenStreetMap (OSM), <strong>Radius Search [pro feature]</strong>, Store Locator, Staff Directory, Employee Directory, Vendors Directory, Restaurant Directory, Company Directory, Local Directory, Contact Manager, <strong>Store Finder</strong>, Address Book for Intranet etc. 

> 🚀 [Support, Bug Report, Feature Requests](https://www.quantumcloud.com/resources/free-support/) | [Simple Business Directory Demo](http://dev.quantumcloud.com/simple-business-directory/) | <strong>Upgrade to [Simple Business Directory Pro ](https://www.quantumcloud.com/products/simple-business-directory/) now with HALLOWEEN SALE! Use coupon code [monster] during checkout.</strong></strong></strong>
